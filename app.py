...
def validar():
    ...
    user = db.usuarios.find_one({"matricula": matricula, "password": password})
    
    if user:
        # El log para el monitor que ves en la terminal
        log_login = {
